...
def extract(path):
  ...
  # Create parameters.py
    ...
    text += f'ReacConst = np.array('+ print_array(ReactConts, 18, [f'{x:>2}. {reactions[x]}' for x in PressureDependentIndexes], ['A_0', 'b_0', 'E_0']) + ', dtype=np.float64)\n\n'
