...
reaction_order = np.array([
    ...
    [   2],    # 12. NNH+NH=N2+NH2
    [   2],    # 13. NNH+NH2=N2+NH3
    [   2],    # 14. NH2+NH2=N2H2+H2
    [   2],    # 15. NH2+NH2=H2NN+H2
    [   2],    # 16. NH2+NH=N2H2+H
    [   2],    # 17. NH2+NH2(+M)=N2H4(+M)
    [   2],    # 18. N2H4+H=N2H3+H2
    [   2],    # 19. N2H4+NH2=N2H3+NH3
    [   1],    # 20. N2H3=N2H2+H
    [   2],    # 21. N2H3+H=N2H2+H2
    [   2],    # 22. N2H3+NH2=N2H2+NH3
    [   2],    # 23. N2H3+NH2=H2NN+NH3
    [   2],    # 24. N2H3+NH=N2H2+NH2
    [   1],    # 25. N2H2=NNH+H
    [   2],    # 26. N2H2+H=NNH+H2
    [   2],    # 27. N2H2+NH2=NNH+NH3
    [   2],    # 28. N2H2+NH=NNH+NH2
    [   1],    # 29. H2NN=NNH+H
    [   1],    # 30. H2NN=NNH+H
    [   2],    # 31. H2NN+H=NNH+H2
    [   2],    # 32. H2NN+H=N2H2+H
    [   2],    # 33. H2NN+NH2=NNH+NH3
    [   1]     # 34. N2+M=N+N+M
], dtype=np.int64)
